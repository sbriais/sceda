...
/** Initialise a list. 
    ...
    @param delete = function to delete data in the list or NULL */
void SCEDA_list_init(SCEDA_List *list, SCEDA_delete_fun delete);

/** Create a new linked list, ready for use.

    @param delete = function to delete data or NULL
...
/** Insert data just after a list element.
    ...
    @param list = list 
    @param element = list element or NULL to insert at list head
...
/** Remove data just after a list element.
    ...
    @param list = list 
    @param element = list element or NULL to remove list head
    @param data = pointer to the removed data
...
/** Remove head of a list
    ...
    @param list = list
    @param data = removed data (filled by the function)
